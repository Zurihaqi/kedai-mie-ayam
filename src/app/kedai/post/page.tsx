...
export default function PostKedai() {
  ...
  const handleInputChange = (event) => {
    ...
    if (name === "fasilitas") {
      ...
      if (isValid && value) {
        const serializedFasilitas = value.split(/\s*,\s*/);
        setFormData({
          ...formData,
  ...
  const handleSubmit = async (event: any) => {
    ...
    if (!imageToUpload) {
      setIsloading(false);
      return toast.error("Harap masukan gambar kedai.");
    }

    if (!formData.harga || !formData.makanan) {
      setIsloading(false);
      return toast.error("Harap isi menu kedai.");
    }
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      placeholder="SCBD, Jl. Jend. Sudirman, Senayan, Daerah Khusus Ibukota Jakarta"
                      required
                      onChange={handleInputChange}
                      className="px-1.5 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-amber-600 sm:text-sm sm:leading-6"
                    />
            ...
            <div className="mt-4">
              ...
              <div className="mt-2">
                <textarea
                  id="fasilitas"
                  name="fasilitas"
                  placeholder="Lesehan, Free Wifi, dst"
                  className="px-1.5 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-amber-600 sm:text-sm sm:leading-6"
                  onChange={handleInputChange}
                />
              </div>
